...
<script setup name="Operlog">
  ...
  const { sys_oper_type: sysOperType, sys_common_status: sysCommonStatus } = proxy.useDict(
    'sys_oper_type',
    'sys_common_status'
  )
  ...
  function typeFormat(row) {
    return proxy.selectDictLabel(sysOperType.value, row.businessType)
  }
  /** 搜索按钮操作 */
